...
# -*- coding:  utf-8 -*
"""
This module is used to learn sparse autoencoder
It is a copy from web source
...
def executeSparseAutoencoder():
    ...
    print " Load randomly sampled image patches as dataset "
    
    training_data = loadDataset(num_patches, vis_patch_side)
    
    print " Initialize the Autoencoder with the above parameters "
    
    encoder = SparseAutoencoder(visible_size, hidden_size, rho, lamda, beta)
    
    print " Run the L-BFGS algorithm to get the optimal parameter values "
    ...
    print " Visualize the obtained optimal W1 weights "
